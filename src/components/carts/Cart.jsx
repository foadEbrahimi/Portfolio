    ...
    <div className="rounded-xl bg-white p-4">
      ...
      <div className="mt-5 flex items-center justify-between">
        <div className="flex items-center gap-1">
          <img src={user} className="w-5" alt="svg" />
          <span className="font-iranSans lg:text-body-medium text-sm font-semibold text-natural-3-caption">
            فواد ابراهیمی
          </span>
        </div>
        <div className="flex items-center gap-1">
          <img src={date} className="w-5" alt="svg" />
          <span className="font-iranSans lg:text-body-medium text-sm font-semibold text-natural-3-caption">
            1403/05/21
          </span>
        </div>
